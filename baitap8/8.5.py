...
# Biến này là kiểu Integer (tương đương với Python int)
v = tk.IntVar()
...
def ShowChoice():
    ...
    # Khi một Radio Button được chọn, giá trị 'value' của nó sẽ được gán cho 'v'
...
for text, val in languages:
    tk.Radiobutton(
        root,
        text=text,               # Tên hiển thị trên nút (Python, Perl,...)
